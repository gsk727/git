...
magazine = Blueprint("magazine", __name__, template_folder="../templates")

magazine.add_url_rule("/groups/<group_member>/magazine/<clientid>",
    view_func =  MagazineView.as_view("gmagazine"))

magazine.add_url_rule("/groups/<group_member>/magazine/<mname>/<clientid>",
    view_func =  MagazineView.as_view("gmagazine"))

magazine.add_url_rule("/groups/<group_member>/magazine/<mname>/<page>",
    view_func =  MagazineView.as_view("gmagazine"))

magazine.add_url_rule("/groups/<group_member>/<magezine>/<mname>/<page>/<clientid>",
        view_func= MagazineView.as_view("gmagazine"))
